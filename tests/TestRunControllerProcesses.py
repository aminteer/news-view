...
if __name__ == '__main__':
    ...
    # dg = DataGateway()
    # dg.save_refined_summary_as_file(nice_summary)
    ...
    # print(f"String has been successfully saved to S3")
